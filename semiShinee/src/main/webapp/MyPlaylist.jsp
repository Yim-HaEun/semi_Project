			...
			<div class="container" style="margin-top:30px;">
	            ...
	            <section>
					...
					%>
							...
							<td><a href="playListDetail.jsp?playlistId=<%=p.getPlaylist_id()%>">
							<img src="<%=p.getImage()%>"style="width : 150px; height: 150px; margin-left:10px; margin-top:10px; border: 3px inset lightgray;"></a></td>
